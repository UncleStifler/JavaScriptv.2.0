...
let multiply = 12 * 12;
document.getElementById('seven').innerHTML = multiply.toString();
...
let hi = document.querySelector(".out-10");
hi.innerHTML = '<h2>Hi</h2>';
...
let z1 = 6;
let z2 = 3;
let mult = document.querySelector(".out-14");
mult.innerHTML = z1 * z2;
...
y1 = 6;
y2 = 3;
let dividir = document.querySelector('.out-15');
dividir.innerHTML = y1 / y2;

// Task 16.
// Создайте две переменные x1='Hello', x2 = 5.  В div.out-16 выведите сумму x1 + x2. Изучите результат операции.
x1 = 'Hello';
x2 = 5;
let sumX = document.querySelector('.out-16');
sumX.innerHTML = x1 + x2;
