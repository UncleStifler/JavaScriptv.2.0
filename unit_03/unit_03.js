...
function f1() {
    ...
    i1 === 4 ? out.innerHTML = true : out.innerHTML = false;
}
...
function f2() {
    ...
    a21 > a22 ? out.innerHTML = a21 : out.innerHTML = a22;
}
...
function f3() {
    ...
    Number(i31) > Number(i32) ? out3.innerHTML = i31 : out3.innerHTML = i32;
}
...
// то вывести в .out-8 строку one, если 2 - two, если 3 - three. Напоминаю - это программирование. Как указано в задании - так и выводим. Т.е. Three с большой буквы - ошибка!!!
...
function f9() {
    ...
    if (i9 >= 1 && i9 <= 32) out9.innerHTML = '1';
    else if (i9 >= 33 && i9 <= 43) out9.innerHTML = '2';
    else if (i9 >= 44 && i9 <= 64) out9.innerHTML = '3';
...
function f10() {
    ...
    let out100 = document.querySelector('.out-10');
    out100.innerHTML = s100.value;
}
...
const selector = document.querySelector('.s-110');
...
function f13() {
    let out = document.querySelector('.i-130').value;
    document.querySelector('.out-13').innerHTML = typeof out;
}
...
function f14() {
    ...
    let selector = document.querySelector('.s-143').value;
