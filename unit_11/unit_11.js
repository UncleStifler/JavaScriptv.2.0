...
// После чего выводит массив в .out-1. Поскольку мы будем выводить массив d1 неоднократно, то давайте вывод массива
// сделаем отдельной функцией, showArr - она подготовлена. Изучите ее - это хороший способ оптимизировать код.
...
function f1() {
    let inner = document.querySelector('.i-1').value;
    d1.push(inner);
    showArr('.out-1', d1);
}
...
function f4() {
    let incoming = document.querySelector('.i-4').value;
    d1.push(incoming);
    showArr('.out-4', d1);
}
...
function f5() {
    let incoming = document.querySelector('.i-5').value;
    d1.push(incoming);
    d1.shift();
    showArr('.out-5', d1);
}
...
function f8() {
    let incoming = document.querySelector('.i-8').value;
...
function f11() {
    let incoming = +document.querySelector('.i-11').value;
    out = d11.indexOf(incoming);
...
function f14() {
    let incoming = +document.querySelector('.i-14').value;
...
function f15() {
    let incoming = +document.querySelector('.i-15').value;
    let check = d15.indexOf(incoming, 0);
    if (check === -1) {
        d15.push(incoming);
    }
...
// Task 17
// Напишите функцию f17, которая эмулирует работу метода concat. Функция должна объединять массивы d171 и d172 и
// записывать результат в d17. Для эмуляции используйте цикл.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f18() {
    let incoming = document.querySelector('.i-18').value;
    out = d18.includes(incoming);
...
// Task 20
// Напишите функцию f20, которая применяет к массиву d20 метод join с параметрами и соединяет элементы массива в одну
// строку. Результат выводит в .out-20. Укажите мето так d20.join('').
