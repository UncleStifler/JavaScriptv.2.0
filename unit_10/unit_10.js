...
let ar1 = [1, 2, 96, 'Vova', true, 'Gosha'];// переменную обьявляем здесь!!!!

function f1() {
    out = document.querySelector('.out-1');
    out.innerHTML = ar1.toString(); // да так можно выводить!!!!
}
...
let ar2 = [...ar1];// переменную объявляем здесь!!!!
...
let ar3 = [...ar1];// переменную обьявляем здесь!!!!
...
function f5() {
    ...
    document.querySelector('.out-5').innerHTML = sum.toString();
}
...
// 6 элемент (индекс 6) равный 5. Выведите массив в .out-8. Разделитель - дефис.
...
function f9() {
    document.querySelector('.out-9').innerHTML = ar9[ar9.length - 1].toString();
}
...
// Task 11
// Напишите функцию, которая меняет местами второй (индекс 2) и четвертый (индекс 4) элемент массива ar11 и
// выводит его в out-11. Разделитель - пробел.
// Во всех задачах где говорим второй, третий и т.д. имеем ввиду индекс
...
function f14() {
    document.querySelector('.out-14').innerHTML = ar14.reverse().join(' ');
}
...
function f16() {
    ...
    document.querySelector('div.out-16-odd').innerHTML = ar16_even.join(' ');
    document.querySelector('div.out-16-even').innerHTML = ar16_odd.join(' ');
}

document.querySelector('.b-16').onclick = f16;

// Task 17
// Используя цикл выведите в .out-17 количество элементов ar17, значение которых больше 3. Для расчета используйте цикл
